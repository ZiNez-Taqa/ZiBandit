...
int main() {
	...
	int age = 0, saldo = 0, spelaom = 1, vf = 0, satsa = 0, pms = 0; //Tönkte anvönda ett Array, men crashade spelet tyvörr
	...
	cout << "Enarmad Bandit ör ett spel där man väljer att spela på 1-8 rader." << endl;
	...
	while (spelaom == 1) { //Spelets Main While-Loop så att man kan spela mer än en gång
		saldo = insöttning(0, saldo); //Tillkallar Insättningensfunktionen
